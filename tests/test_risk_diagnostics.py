...
def test_risk_diagnostics_counts_reasons_and_percentiles() -> None:
    events = [
        make_event(
            ...
            venue="bitbank",
            symbol="BTC/JPY",
            payload={"allow_quote": False, "reason": "activation_too_low", "activation": 0.0, "force_ratio": 0.1, "depth_20bps": 100},
        ),
        make_event(
            "risk_state",
            ts_exchange=2,
            venue="bitbank",
            symbol="BTC/JPY",
            payload={"allow_quote": False, "reason": "activation_too_low", "activation": 0.05, "force_ratio": 0.2, "depth_20bps": 200},
        ),
        make_event(
            "risk_state",
            ts_exchange=3,
            venue="bitbank",
            symbol="BTC/JPY",
            payload={"allow_quote": True, "reason": None, "activation": 0.2, "force_ratio": 0.4, "depth_20bps": 300},
        ),
    ]
